...
numPhases=11000  # all applications complete at leaste 200 B instructions
...
while read WL; do
	...
	numactl -C 8 /home/lupones/kpart/src/kpart $perfCounters $phaseLen $logFile $warmupPeriod $profilingPeriod $processStr 2>&1 | tee -a output.log
